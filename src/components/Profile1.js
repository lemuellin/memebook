        ...
        fullRows.push(
            <Row key={uniqid()}>
                <Col className="d-flex justify-content-center">
                    <img src={postList[3*i-3].imgURL} style={{width: "20vw"}}/>
                </Col>
                <Col className="d-flex justify-content-center">
                    <img src={postList[3*i-2].imgURL} style={{width: "20vw"}}/>
                </Col>
                <Col className="d-flex justify-content-center">
                    <img src={postList[3*i-1].imgURL} style={{width: "20vw"}}/>
                </Col>
            </Row>
        );
    }
    ...
    if(remainderNum == 1){
        remainderRows.push(
            <Col key={uniqid()} className="d-flex justify-content-center">
                <img src={postList[postList.length - 1].imgURL} style={{width: "20vw"}}/>
            </Col>
        );
        remainderRows.push(
            <Col key={uniqid()} className="d-flex justify-content-center">
        ...
        for (let i = 2; i >= 1; i--){
            remainderRows.push(
                <Col key={uniqid()} className="d-flex justify-content-center">
                    <img src={postList[postList.length - i].imgURL} style={{width: "20vw"}}/>
                </Col>
            );
        }
        remainderRows.push(
